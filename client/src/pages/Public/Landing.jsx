          ...
          <div className="flex gap-4 items-center">
            ...
            <Link to="/track">
              <Button
                variant="primary"
                size="sm"
                className="hidden sm:inline-flex shadow-xl shadow-black/5"
              >
                Track Shipment
              </Button>
            </Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl animate-modern-fade pt-10">
            ...
            <p className="text-lg md:text-xl text-zinc-500 max-w-2xl mb-10 leading-relaxed font-normal">
              ...
              Predict delays before they happen with our traffic-aware AI engine
              and automate your dispatch workflow.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link to="/track">
                <Button
                  size="lg"
                  className="px-8 w-full sm:w-auto h-12 text-base shadow-lg shadow-black/10 hover:shadow-xl transition-all"
                >
              ...
              <a href="#process">
                <Button
                  variant="secondary"
                  size="lg"
                  className="px-8 w-full sm:w-auto h-12 text-base bg-white"
                >
                  See How It Works
                </Button>
              </a>
          ...
          <div className="mb-12 flex items-end justify-between border-b border-zinc-100 pb-6">
            <div>
              ...
              <p className="text-zinc-500 text-sm max-w-md">
                Streamlined from order to delivery.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <p className="mt-4 text-zinc-400 max-w-2xl">
              Our proprietary AI engine doesn't just guess—it analyzes thousands
              of data points to provide accurate ETAs that adapt to the real
              world.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-2 gap-4 h-auto md:h-[500px]">
            ...
            <div className="md:col-span-2 md:row-span-2 p-8 border border-white/10 bg-zinc-900/50 hover:bg-zinc-900 transition-colors group flex flex-col justify-between relative overflow-hidden">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm leading-relaxed max-w-md mb-6">
                  Standard GPS estimates fail during peak times. Our model
                  detects historical traffic patterns, day-of-week congestion,
                  and specific "Rush Hour" windows to adjust delivery
            ...
            <div className="p-6 border border-white/10 bg-zinc-900/50 hover:bg-zinc-900 transition-colors">
              ...
              <p className="text-zinc-400 text-xs">
                Rain, snow, or clear skies? The system adjusts travel speeds
            ...
            <div className="p-6 border border-white/10 bg-zinc-900/50 hover:bg-zinc-900 transition-colors">
              ...
              <p className="text-zinc-400 text-xs">
                Custom routing logic for Heavy Trucks vs. Delivery Vans to
                ensure safe and legal pathing.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="md:w-1/2">
                ...
                <p className="text-zinc-500 mb-8 leading-relaxed">
                  From single-driver operations to global fleets, our platform
                  scales with you. Manage users, analyze performance, and secure
                  your data in one unified dashboard.
                </p>
                <div className="flex gap-3">
                  ...
                  <Link to="/register-shop">
                    <Button variant="secondary">Register your shop</Button>
                  </Link>
                </div>
              </div>
              ...
              <div className="md:w-1/2 w-full grid grid-cols-2 gap-4">
                <FeatureCard
                  icon={Shield}
                  label="Secure Access"
                  sub="Role-Based Controls"
                />
                <FeatureCard
                  icon={BarChart3}
                  label="Analytics"
                  sub="Performance Reports"
                />
                <FeatureCard
                  icon={Smartphone}
                  label="Driver App"
                  sub="Mobile Optimized"
                />
                <FeatureCard
                  icon={Calendar}
                  label="Scheduling"
                  sub="Automated Planning"
                />
              </div>
            </div>
          </div>
...
function Stat({ label, value, sub }) {
  return (
    <div className="p-4 border border-zinc-100 bg-zinc-50/50 hover:border-zinc-300 transition-all text-center md:text-left cursor-default">
      <div className="text-2xl md:text-3xl font-bold tracking-tighter text-black mb-1">
        {value}
      </div>
