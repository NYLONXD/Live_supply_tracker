...
import bgImage from '../assets/bg-history.png';
...
const ShipmentHistory = () => {
  ...
  return (
    <div className="relative bg-white rounded-2xl p-4 shadow-xl h-[80vh] overflow-y-auto">
      {/* Background image using webkit */}
      <div
